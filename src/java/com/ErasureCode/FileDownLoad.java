...
//                            encrypter.encrypt(new FileInputStream("C:/temp10/"+ filename),new FileOutputStream(TempDownloadDirectory+filename));
//                           Decrypter.decrypt(new FileInputStream("C:/temp10/"+ filename),new FileOutputStream(TempDownloadDirectory+filename));
//                
...
//            }
//            
//            String dummy1="C:/"+filename;
//            String dummy2=server2+"/"+filename;
//            String dummy3=server3+"/"+filename;
//            String dummy4=server4+"/"+filename;
//            
//            
//            
//            File datafiles1=new File(dummy1);
//            File datafiles2=new File(dummy2);
//            File datafiles3=new File(dummy3);
//            File datafiles4=new File(dummy4);
//            
...
//            
//            
//             System.err.println("file name analysis========"+dummy1);
//             
//             
//             
//            
