...
int ff=Integer.parseInt(String.valueOf(fileSize));
int s=ff/1024;
int m=s/4;
System.out.println("pirucha size"+m+"File Name"+name);
...
//                
                System.out.println("Store in AES");
        ...
        try (BufferedInputStream bis = new BufferedInputStream(
                new FileInputStream(TempUploadDirectory + File.separator + nn))) {//try-with-resources to ensure closing stream
